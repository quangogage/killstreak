    ...
    return (
      <div className="About page">
        ...
        <div className="content">
          I started Killstreak to help create a platform for underground artsits
          such as myself to be heard and have a voice. <br />
          <br />
          We are an independently owned brand based out of the pacific northwest
          providing a versatile set of products.<br />
          <br />
          By incorporating a lot of everyday life into my work, I try to focus
          on capturing the smaller things in life that people tend to pass up by
